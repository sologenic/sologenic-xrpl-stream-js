...
class XrplAccount {
    ...
    validate() {
        if (!xrpl.isValidAddress(this.address)) {
            throw new XrplAddressException('Address is not valid', new xrpl.ValidationError());
        }
        if (typeof this.secret !== 'undefined' &&
            !xrpl.isValidSecret(this.secret)) {
            throw new XrplSecretException('Secret is not valid', new xrpl.ValidationError());
        }
        if (typeof this.keypair === 'object' &&
            (typeof this.keypair.publicKey === 'undefined' ||
                typeof this.keypair.privateKey === 'undefined')) {
            throw new XrplKeypairException('Keypair is not valid', new xrpl.ValidationError());
        }
