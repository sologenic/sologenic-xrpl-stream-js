...
export default class XrplAccount {
    constructor(address: string, secret?: string, publicKey?: string, privateKey?: string, mnemonic?: string);
    /**
     * Ripple API
     */
     ...
     */
    static getAccount(address: string, secret?: string, publicKey?: string, privateKey?: string, mnemonic?: string): XrplAccount;
    /**
     * Validate an account
     */
    validate(): void;
