[typescript](../README.md) › [Globals](../globals.md) › ["crypto"](../modules/_crypto_.md) › [DecipherGCM](_crypto_.deciphergcm.md)
...
* [constructor](_crypto_.deciphergcm.md#constructor)

### Properties

* [destroyed](_crypto_.deciphergcm.md#destroyed)
* [readable](_crypto_.deciphergcm.md#readable)
* [readableHighWaterMark](_crypto_.deciphergcm.md#readablehighwatermark)
* [readableLength](_crypto_.deciphergcm.md#readablelength)
* [readableObjectMode](_crypto_.deciphergcm.md#readableobjectmode)
* [writable](_crypto_.deciphergcm.md#writable)
* [writableFinished](_crypto_.deciphergcm.md#writablefinished)
* [writableHighWaterMark](_crypto_.deciphergcm.md#writablehighwatermark)
* [writableLength](_crypto_.deciphergcm.md#writablelength)
* [writableObjectMode](_crypto_.deciphergcm.md#writableobjectmode)
* [defaultMaxListeners](_crypto_.deciphergcm.md#static-defaultmaxlisteners)

### Methods

* [[Symbol.asyncIterator]](_crypto_.deciphergcm.md#[symbol.asynciterator])
* [_destroy](_crypto_.deciphergcm.md#_destroy)
* [_final](_crypto_.deciphergcm.md#_final)
* [_flush](_crypto_.deciphergcm.md#_flush)
* [_read](_crypto_.deciphergcm.md#_read)
* [_transform](_crypto_.deciphergcm.md#_transform)
* [_write](_crypto_.deciphergcm.md#_write)
* [_writev](_crypto_.deciphergcm.md#optional-_writev)
* [addListener](_crypto_.deciphergcm.md#addlistener)
* [cork](_crypto_.deciphergcm.md#cork)
* [destroy](_crypto_.deciphergcm.md#destroy)
* [emit](_crypto_.deciphergcm.md#emit)
* [end](_crypto_.deciphergcm.md#end)
* [eventNames](_crypto_.deciphergcm.md#eventnames)
* [final](_crypto_.deciphergcm.md#final)
* [getMaxListeners](_crypto_.deciphergcm.md#getmaxlisteners)
* [isPaused](_crypto_.deciphergcm.md#ispaused)
* [listenerCount](_crypto_.deciphergcm.md#listenercount)
* [listeners](_crypto_.deciphergcm.md#listeners)
* [off](_crypto_.deciphergcm.md#off)
* [on](_crypto_.deciphergcm.md#on)
* [once](_crypto_.deciphergcm.md#once)
* [pause](_crypto_.deciphergcm.md#pause)
* [pipe](_crypto_.deciphergcm.md#pipe)
* [prependListener](_crypto_.deciphergcm.md#prependlistener)
* [prependOnceListener](_crypto_.deciphergcm.md#prependoncelistener)
* [push](_crypto_.deciphergcm.md#push)
* [rawListeners](_crypto_.deciphergcm.md#rawlisteners)
* [read](_crypto_.deciphergcm.md#read)
* [removeAllListeners](_crypto_.deciphergcm.md#removealllisteners)
* [removeListener](_crypto_.deciphergcm.md#removelistener)
* [resume](_crypto_.deciphergcm.md#resume)
* [setAAD](_crypto_.deciphergcm.md#setaad)
* [setAuthTag](_crypto_.deciphergcm.md#setauthtag)
* [setAutoPadding](_crypto_.deciphergcm.md#setautopadding)
* [setDefaultEncoding](_crypto_.deciphergcm.md#setdefaultencoding)
* [setEncoding](_crypto_.deciphergcm.md#setencoding)
* [setMaxListeners](_crypto_.deciphergcm.md#setmaxlisteners)
* [uncork](_crypto_.deciphergcm.md#uncork)
* [unpipe](_crypto_.deciphergcm.md#unpipe)
* [unshift](_crypto_.deciphergcm.md#unshift)
* [update](_crypto_.deciphergcm.md#update)
* [wrap](_crypto_.deciphergcm.md#wrap)
* [write](_crypto_.deciphergcm.md#write)
* [from](_crypto_.deciphergcm.md#static-from)
* [listenerCount](_crypto_.deciphergcm.md#static-listenercount)

## Constructors

###  constructor

\+ **new DecipherGCM**(`opts?`: [TransformOptions](_stream_.internal.transformoptions.md)): *[DecipherGCM](_crypto_.deciphergcm.md)*
...
**Returns:** *[DecipherGCM](_crypto_.deciphergcm.md)*
...
▸ **setAAD**(`buffer`: [ArrayBufferView](../modules/nodejs.md#arraybufferview), `options?`: undefined | object): *this*
