[typescript](../README.md) › [Globals](../globals.md) › ["zlib"](../modules/_zlib_.md) › [Gzip](_zlib_.gzip.md)
...
* [constructor](_zlib_.gzip.md#constructor)

### Properties

* [bytesRead](_zlib_.gzip.md#bytesread)
* [bytesWritten](_zlib_.gzip.md#byteswritten)
* [destroyed](_zlib_.gzip.md#destroyed)
* [readable](_zlib_.gzip.md#readable)
* [readableHighWaterMark](_zlib_.gzip.md#readablehighwatermark)
* [readableLength](_zlib_.gzip.md#readablelength)
* [readableObjectMode](_zlib_.gzip.md#readableobjectmode)
* [shell](_zlib_.gzip.md#optional-shell)
* [writable](_zlib_.gzip.md#writable)
* [writableFinished](_zlib_.gzip.md#writablefinished)
* [writableHighWaterMark](_zlib_.gzip.md#writablehighwatermark)
* [writableLength](_zlib_.gzip.md#writablelength)
* [writableObjectMode](_zlib_.gzip.md#writableobjectmode)
* [defaultMaxListeners](_zlib_.gzip.md#static-defaultmaxlisteners)

### Methods

* [[Symbol.asyncIterator]](_zlib_.gzip.md#[symbol.asynciterator])
* [_destroy](_zlib_.gzip.md#_destroy)
* [_final](_zlib_.gzip.md#_final)
* [_flush](_zlib_.gzip.md#_flush)
* [_read](_zlib_.gzip.md#_read)
* [_transform](_zlib_.gzip.md#_transform)
* [_write](_zlib_.gzip.md#_write)
* [_writev](_zlib_.gzip.md#optional-_writev)
* [addListener](_zlib_.gzip.md#addlistener)
* [close](_zlib_.gzip.md#close)
* [cork](_zlib_.gzip.md#cork)
* [destroy](_zlib_.gzip.md#destroy)
* [emit](_zlib_.gzip.md#emit)
* [end](_zlib_.gzip.md#end)
* [eventNames](_zlib_.gzip.md#eventnames)
* [flush](_zlib_.gzip.md#flush)
* [getMaxListeners](_zlib_.gzip.md#getmaxlisteners)
* [isPaused](_zlib_.gzip.md#ispaused)
* [listenerCount](_zlib_.gzip.md#listenercount)
* [listeners](_zlib_.gzip.md#listeners)
* [off](_zlib_.gzip.md#off)
* [on](_zlib_.gzip.md#on)
* [once](_zlib_.gzip.md#once)
* [pause](_zlib_.gzip.md#pause)
* [pipe](_zlib_.gzip.md#pipe)
* [prependListener](_zlib_.gzip.md#prependlistener)
* [prependOnceListener](_zlib_.gzip.md#prependoncelistener)
* [push](_zlib_.gzip.md#push)
* [rawListeners](_zlib_.gzip.md#rawlisteners)
* [read](_zlib_.gzip.md#read)
* [removeAllListeners](_zlib_.gzip.md#removealllisteners)
* [removeListener](_zlib_.gzip.md#removelistener)
* [resume](_zlib_.gzip.md#resume)
* [setDefaultEncoding](_zlib_.gzip.md#setdefaultencoding)
* [setEncoding](_zlib_.gzip.md#setencoding)
* [setMaxListeners](_zlib_.gzip.md#setmaxlisteners)
* [uncork](_zlib_.gzip.md#uncork)
* [unpipe](_zlib_.gzip.md#unpipe)
* [unshift](_zlib_.gzip.md#unshift)
* [wrap](_zlib_.gzip.md#wrap)
* [write](_zlib_.gzip.md#write)
* [from](_zlib_.gzip.md#static-from)
* [listenerCount](_zlib_.gzip.md#static-listenercount)

## Constructors

###  constructor

\+ **new Gzip**(`opts?`: [TransformOptions](_stream_.internal.transformoptions.md)): *[Gzip](_zlib_.gzip.md)*
