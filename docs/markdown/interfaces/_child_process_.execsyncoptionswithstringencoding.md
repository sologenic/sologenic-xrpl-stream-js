[typescript](../README.md) › [Globals](../globals.md) › ["child_process"](../modules/_child_process_.md) › [ExecSyncOptionsWithStringEncoding](_child_process_.execsyncoptionswithstringencoding.md)
