[typescript](../README.md) › [Globals](../globals.md) › ["child_process"](../modules/_child_process_.md) › [SpawnOptionsWithStdioTuple](_child_process_.spawnoptionswithstdiotuple.md)
