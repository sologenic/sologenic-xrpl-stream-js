[typescript](../README.md) › [Globals](../globals.md) › ["crypto"](../modules/_crypto_.md) › [DecipherCCM](_crypto_.decipherccm.md)
...
* [constructor](_crypto_.decipherccm.md#constructor)

### Properties

* [destroyed](_crypto_.decipherccm.md#destroyed)
* [readable](_crypto_.decipherccm.md#readable)
* [readableHighWaterMark](_crypto_.decipherccm.md#readablehighwatermark)
* [readableLength](_crypto_.decipherccm.md#readablelength)
* [readableObjectMode](_crypto_.decipherccm.md#readableobjectmode)
* [writable](_crypto_.decipherccm.md#writable)
* [writableFinished](_crypto_.decipherccm.md#writablefinished)
* [writableHighWaterMark](_crypto_.decipherccm.md#writablehighwatermark)
* [writableLength](_crypto_.decipherccm.md#writablelength)
* [writableObjectMode](_crypto_.decipherccm.md#writableobjectmode)
* [defaultMaxListeners](_crypto_.decipherccm.md#static-defaultmaxlisteners)

### Methods

* [[Symbol.asyncIterator]](_crypto_.decipherccm.md#[symbol.asynciterator])
* [_destroy](_crypto_.decipherccm.md#_destroy)
* [_final](_crypto_.decipherccm.md#_final)
* [_flush](_crypto_.decipherccm.md#_flush)
* [_read](_crypto_.decipherccm.md#_read)
* [_transform](_crypto_.decipherccm.md#_transform)
* [_write](_crypto_.decipherccm.md#_write)
* [_writev](_crypto_.decipherccm.md#optional-_writev)
* [addListener](_crypto_.decipherccm.md#addlistener)
* [cork](_crypto_.decipherccm.md#cork)
* [destroy](_crypto_.decipherccm.md#destroy)
* [emit](_crypto_.decipherccm.md#emit)
* [end](_crypto_.decipherccm.md#end)
* [eventNames](_crypto_.decipherccm.md#eventnames)
* [final](_crypto_.decipherccm.md#final)
* [getMaxListeners](_crypto_.decipherccm.md#getmaxlisteners)
* [isPaused](_crypto_.decipherccm.md#ispaused)
* [listenerCount](_crypto_.decipherccm.md#listenercount)
* [listeners](_crypto_.decipherccm.md#listeners)
* [off](_crypto_.decipherccm.md#off)
* [on](_crypto_.decipherccm.md#on)
* [once](_crypto_.decipherccm.md#once)
* [pause](_crypto_.decipherccm.md#pause)
* [pipe](_crypto_.decipherccm.md#pipe)
* [prependListener](_crypto_.decipherccm.md#prependlistener)
* [prependOnceListener](_crypto_.decipherccm.md#prependoncelistener)
* [push](_crypto_.decipherccm.md#push)
* [rawListeners](_crypto_.decipherccm.md#rawlisteners)
* [read](_crypto_.decipherccm.md#read)
* [removeAllListeners](_crypto_.decipherccm.md#removealllisteners)
* [removeListener](_crypto_.decipherccm.md#removelistener)
* [resume](_crypto_.decipherccm.md#resume)
* [setAAD](_crypto_.decipherccm.md#setaad)
* [setAuthTag](_crypto_.decipherccm.md#setauthtag)
* [setAutoPadding](_crypto_.decipherccm.md#setautopadding)
* [setDefaultEncoding](_crypto_.decipherccm.md#setdefaultencoding)
* [setEncoding](_crypto_.decipherccm.md#setencoding)
* [setMaxListeners](_crypto_.decipherccm.md#setmaxlisteners)
* [uncork](_crypto_.decipherccm.md#uncork)
* [unpipe](_crypto_.decipherccm.md#unpipe)
* [unshift](_crypto_.decipherccm.md#unshift)
* [update](_crypto_.decipherccm.md#update)
* [wrap](_crypto_.decipherccm.md#wrap)
* [write](_crypto_.decipherccm.md#write)
* [from](_crypto_.decipherccm.md#static-from)
* [listenerCount](_crypto_.decipherccm.md#static-listenercount)

## Constructors

###  constructor

\+ **new DecipherCCM**(`opts?`: [TransformOptions](_stream_.internal.transformoptions.md)): *[DecipherCCM](_crypto_.decipherccm.md)*
...
**Returns:** *[DecipherCCM](_crypto_.decipherccm.md)*
...
*Inherited from [Decipher](../classes/_crypto_.decipher.md).[final](../classes/_crypto_.decipher.md#final)*
...
▸ **setAAD**(`buffer`: [ArrayBufferView](../modules/nodejs.md#arraybufferview), `options`: object): *this*

Defined in node_modules/@types/node/crypto.d.ts:258

**Parameters:**

▪ **buffer**: *[ArrayBufferView](../modules/nodejs.md#arraybufferview)*
...
▸ **setAuthTag**(`buffer`: [ArrayBufferView](../modules/nodejs.md#arraybufferview)): *this*

Defined in node_modules/@types/node/crypto.d.ts:257
...
*Inherited from [Decipher](../classes/_crypto_.decipher.md).[setAutoPadding](../classes/_crypto_.decipher.md#setautopadding)*

Defined in node_modules/@types/node/crypto.d.ts:252
...
▸ **update**(`data`: [ArrayBufferView](../modules/nodejs.md#arraybufferview)): *[Buffer](../classes/buffer.md)*

*Inherited from [Decipher](../classes/_crypto_.decipher.md).[update](../classes/_crypto_.decipher.md#update)*

Defined in node_modules/@types/node/crypto.d.ts:246
...
▸ **update**(`data`: string, `input_encoding`: [HexBase64BinaryEncoding](../modules/_crypto_.md#hexbase64binaryencoding)): *[Buffer](../classes/buffer.md)*

*Inherited from [Decipher](../classes/_crypto_.decipher.md).[update](../classes/_crypto_.decipher.md#update)*

Defined in node_modules/@types/node/crypto.d.ts:247
...
------ | ------ |
`data` | string |
`input_encoding` | [HexBase64BinaryEncoding](../modules/_crypto_.md#hexbase64binaryencoding) |

**Returns:** *[Buffer](../classes/buffer.md)*

▸ **update**(`data`: [ArrayBufferView](../modules/nodejs.md#arraybufferview), `input_encoding`: undefined, `output_encoding`: [Utf8AsciiBinaryEncoding](../modules/_crypto_.md#utf8asciibinaryencoding)): *string*

*Inherited from [Decipher](../classes/_crypto_.decipher.md).[update](../classes/_crypto_.decipher.md#update)*

Defined in node_modules/@types/node/crypto.d.ts:248
...
`output_encoding` | [Utf8AsciiBinaryEncoding](../modules/_crypto_.md#utf8asciibinaryencoding) |

**Returns:** *string*

▸ **update**(`data`: string, `input_encoding`: [HexBase64BinaryEncoding](../modules/_crypto_.md#hexbase64binaryencoding) | undefined, `output_encoding`: [Utf8AsciiBinaryEncoding](../modules/_crypto_.md#utf8asciibinaryencoding)): *string*

*Inherited from [Decipher](../classes/_crypto_.decipher.md).[update](../classes/_crypto_.decipher.md#update)*

Defined in node_modules/@types/node/crypto.d.ts:249
...
------ | ------ |
`data` | string |
`input_encoding` | [HexBase64BinaryEncoding](../modules/_crypto_.md#hexbase64binaryencoding) &#124; undefined |
`output_encoding` | [Utf8AsciiBinaryEncoding](../modules/_crypto_.md#utf8asciibinaryencoding) |
