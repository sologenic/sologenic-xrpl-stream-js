[typescript](../README.md) › [Globals](../globals.md) › ["child_process"](../modules/_child_process_.md) › [ExecFileOptionsWithBufferEncoding](_child_process_.execfileoptionswithbufferencoding.md)
