[typescript](../README.md) › [Globals](../globals.md) › ["crypto"](../modules/_crypto_.md) › [Decipher](_crypto_.decipher.md)
...
* [constructor](_crypto_.decipher.md#private-constructor)

### Properties

* [destroyed](_crypto_.decipher.md#destroyed)
* [readable](_crypto_.decipher.md#readable)
* [readableHighWaterMark](_crypto_.decipher.md#readablehighwatermark)
* [readableLength](_crypto_.decipher.md#readablelength)
* [readableObjectMode](_crypto_.decipher.md#readableobjectmode)
* [writable](_crypto_.decipher.md#writable)
* [writableFinished](_crypto_.decipher.md#writablefinished)
* [writableHighWaterMark](_crypto_.decipher.md#writablehighwatermark)
* [writableLength](_crypto_.decipher.md#writablelength)
* [writableObjectMode](_crypto_.decipher.md#writableobjectmode)
* [defaultMaxListeners](_crypto_.decipher.md#static-defaultmaxlisteners)

### Methods

* [[Symbol.asyncIterator]](_crypto_.decipher.md#[symbol.asynciterator])
* [_destroy](_crypto_.decipher.md#_destroy)
* [_final](_crypto_.decipher.md#_final)
* [_flush](_crypto_.decipher.md#_flush)
* [_read](_crypto_.decipher.md#_read)
* [_transform](_crypto_.decipher.md#_transform)
* [_write](_crypto_.decipher.md#_write)
* [_writev](_crypto_.decipher.md#optional-_writev)
* [addListener](_crypto_.decipher.md#addlistener)
* [cork](_crypto_.decipher.md#cork)
* [destroy](_crypto_.decipher.md#destroy)
* [emit](_crypto_.decipher.md#emit)
* [end](_crypto_.decipher.md#end)
* [eventNames](_crypto_.decipher.md#eventnames)
* [final](_crypto_.decipher.md#final)
* [getMaxListeners](_crypto_.decipher.md#getmaxlisteners)
* [isPaused](_crypto_.decipher.md#ispaused)
* [listenerCount](_crypto_.decipher.md#listenercount)
* [listeners](_crypto_.decipher.md#listeners)
* [off](_crypto_.decipher.md#off)
* [on](_crypto_.decipher.md#on)
* [once](_crypto_.decipher.md#once)
* [pause](_crypto_.decipher.md#pause)
* [pipe](_crypto_.decipher.md#pipe)
* [prependListener](_crypto_.decipher.md#prependlistener)
* [prependOnceListener](_crypto_.decipher.md#prependoncelistener)
* [push](_crypto_.decipher.md#push)
* [rawListeners](_crypto_.decipher.md#rawlisteners)
* [read](_crypto_.decipher.md#read)
* [removeAllListeners](_crypto_.decipher.md#removealllisteners)
* [removeListener](_crypto_.decipher.md#removelistener)
* [resume](_crypto_.decipher.md#resume)
* [setAutoPadding](_crypto_.decipher.md#setautopadding)
* [setDefaultEncoding](_crypto_.decipher.md#setdefaultencoding)
* [setEncoding](_crypto_.decipher.md#setencoding)
* [setMaxListeners](_crypto_.decipher.md#setmaxlisteners)
* [uncork](_crypto_.decipher.md#uncork)
* [unpipe](_crypto_.decipher.md#unpipe)
* [unshift](_crypto_.decipher.md#unshift)
* [update](_crypto_.decipher.md#update)
* [wrap](_crypto_.decipher.md#wrap)
* [write](_crypto_.decipher.md#write)
* [from](_crypto_.decipher.md#static-from)
* [listenerCount](_crypto_.decipher.md#static-listenercount)

## Constructors

### `Private` constructor

\+ **new Decipher**(): *[Decipher](_crypto_.decipher.md)*
...
**Returns:** *[Decipher](_crypto_.decipher.md)*
...
▸ **update**(`data`: [ArrayBufferView](../modules/nodejs.md#arraybufferview)): *[Buffer](buffer.md)*
...
▸ **update**(`data`: string, `input_encoding`: [HexBase64BinaryEncoding](../modules/_crypto_.md#hexbase64binaryencoding)): *[Buffer](buffer.md)*
