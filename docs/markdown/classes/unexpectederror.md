[typescript](../README.md) › [Globals](../globals.md) › [UnexpectedError](unexpectederror.md)
...
* [constructor](unexpectederror.md#constructor)

### Properties

* [data](unexpectederror.md#optional-data)
* [message](unexpectederror.md#message)
* [name](unexpectederror.md#name)
* [stack](unexpectederror.md#optional-stack)

### Methods

* [inspect](unexpectederror.md#inspect)
* [toString](unexpectederror.md#tostring)

## Constructors

###  constructor

\+ **new UnexpectedError**(`message?`: undefined | string, `data?`: any): *[UnexpectedError](unexpectederror.md)*
...
**Returns:** *[UnexpectedError](unexpectederror.md)*
