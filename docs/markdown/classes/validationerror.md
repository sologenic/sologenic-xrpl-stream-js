[typescript](../README.md) › [Globals](../globals.md) › [ValidationError](validationerror.md)
...
* [data](validationerror.md#optional-data)
...
* [inspect](validationerror.md#inspect)
...
\+ **new ValidationError**(`message?`: undefined | string, `data?`: any): *[ValidationError](validationerror.md)*
